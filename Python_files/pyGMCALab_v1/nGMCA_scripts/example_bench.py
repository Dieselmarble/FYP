...
from pyGMCA.core.benchmark import Benchmark


# load the provided configuration file
#bench = Benchmark("benchmarks/bench_lambda.py")
bench = Benchmark("benchmarks/bench_db_basic.py")
...
bench = Benchmark("benchmarks/bench_S_tau_mad_P5MC12_04déc14_1042_820818.bch")
