...
rem ********************************************************************
rem C++: LINKFLAGS= -static-libgcc -static-libstdc++ -shared mex.def "-L%LIBLOC%"
...
set LINKFLAGS= -static-libgcc -static-libstdc++ -shared mex.def "-L%LIBLOC%"
rem set COMPFLAGS=-c -DMATLAB_MEX_FILE
rem set LINKFLAGSPOST= -lmex -lmx -lmwlapack -lmwblas
set LINKFLAGSPOST= -lmex -lmx -lmwlapack -lmwblas -lgomp
